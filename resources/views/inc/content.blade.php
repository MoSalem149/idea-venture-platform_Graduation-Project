        ...
        <div class="row">
            <div class="col-xl-5 col-lg-8">
                <div class="hero__content">
                    ...
                    <a href="{{ route('register') }}" class="cmn-btn text-uppercase font-weight-600 mt-4">Get Started</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-6">
                <div class="choose-card border-radius--5 about-content">
                    ...
                    <a href="{{ route('about') }}" class="cmn-btn mt-4">MORE INFO</a>
                </div>
                <!-- about-content end -->
            </div>
        </div>
        ...
        <div class="row justify-content-center mb-none-30">
            <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                <div class="package-card text-center bg_img"
                    ...
                    <a href="{{ route('login') }}" class="cmn-btn btn-md mt-4">Subscribe Now</a>
                </div>
                <!-- package-card end -->
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mb-none-30">
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-30">
                <div class="team-card">
                    <div class="team-card__thumb">
                        <img src="{{ asset('assets/images/teams/1.jpg') }}" alt="Mohamed Belal" />
                    </div>
                    <div class="team-card__content">
                        ...
                        <div class="team-card__icons">
                            <a href="https://linkedin.com/in/muhammed-belal-b27b14280" target="_blank"><i
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-30">
                <div class="team-card">
                    <div class="team-card__thumb">
                        <img src="{{ asset('assets/images/teams/2.jpg') }}" alt="Mohamed Salem" />
                    </div>
                    <div class="team-card__content">
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-30">
                <div class="team-card">
                    <div class="team-card__thumb">
                        <img src="{{ asset('assets/images/teams/9.jpg') }}" alt="Mohamed Nasr" />
                    </div>
                    <div class="team-card__content">
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-30">
                <div class="team-card">
                    <div class="team-card__thumb">
                        <img src="{{ asset('assets/images/teams/3.jpg') }}" alt="Karim Sherif" />
                    </div>
                    <div class="team-card__content">
                        <h4 class="name mb-1">
                            Karim <br />
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-30">
                <div class="team-card">
                    <div class="team-card__thumb">
                        <img src="{{ asset('assets/images/teams/10.jpg') }}" alt="Abdelrahman Radwan" />
                    </div>
                    <div class="team-card__content">
        ...
        <div class="row justify-content-center mb-none-30 mt-5">
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-30">
                <div class="team-card">
                    <div class="team-card__thumb">
                        <img src="{{ asset('assets/images/teams/7.jpg') }}" alt="Eman Eid" />
                    </div>
                    <div class="team-card__content">
                        <h4 class="name mb-1">
                            Eman <br />
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-30">
                <div class="team-card">
                    <div class="team-card__thumb">
                        <img src="{{ asset('assets/images/teams/8.jpg') }}" alt="Ritan Hassanein" />
                    </div>
                    <div class="team-card__content">
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-30">
                <div class="team-card">
                    <div class="team-card__thumb">
                        <img src="{{ asset('assets/images/teams/5.jpg') }}" alt="Omar Awad" />
                    </div>
                    <div class="team-card__content">
                        <h4 class="name mb-1">Omar Awad</h4>
                        <hr />
                        <span class="designation">Business Mangment</span>
                        <div class="team-card__icons">
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-30">
                <div class="team-card">
                    <div class="team-card__thumb">
                        <img src="{{ asset('assets/images/teams/4.jpg') }}" alt="Mohamed Darwish" />
                    </div>
                    <div class="team-card__content">
            ...
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 mb-30">
                <div class="team-card">
                    <div class="team-card__thumb">
                        <img src="{{ asset('assets/images/teams/6.png') }}" alt="Omar Fayez" />
                    </div>
                    <div class="team-card__content">
                        <h4 class="name mb-1">
                            Omar <br />
        ...
        <div class="row justify-content-center mb-none-30">
            <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
                <div class="investor-card border-radius--5">
                    ...
                    <div class="investor-card__content">
                        <h6 class="name">Ibrahim Gamal</h6>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
                <div class="investor-card border-radius--5">
                    ...
                    <div class="investor-card__content">
                        <h6 class="name">Mohamed Moustafa</h6>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-8">
                <div class="cta-wrapper bg_img border-radius--10 text-center"
                    ...
                    <a href="{{ route('register') }}" class="cmn-btn mt-4">Join Us</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="blog-card">
                    ...
                    <div class="blog-card__content">
                        ...
                        <p>
                            ...
                            towards success Learn strategies for overcoming.
                        </p>
                        <a href="#0" class="cmn-btn btn-md mt-4">Read More</a>
                    </div>
                </div>
